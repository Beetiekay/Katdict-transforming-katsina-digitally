    ...
    <div className='lg:overflow-visible md:overflow-visible overflow-y-scroll h-[100vh]'>
     <div className='w-[100%] h-[100vh] bg-seagreen  bg-opacity-35 relative '>
        ...
        <div className='absolute z-20'><Navigation/></div>
          <div className='py-40'>
            ...
            <div className='grid grid-cols-2 gap-4 lg:w-fit md:w-fit w-[180vw] lg:mb-0 md:mb-0 mb-4'>
                <div data-aos="flip-right" className='bg-white py-6 px-4'>
                    <h1 className='bg-green py-2 px-3 text-white text-2xl w-44 mb-4'>Overview</h1>
                    <p className='text-2xl mb-6'>
                    Using a laptop computer, Smartphone or iPad has become an essential part of everyday life for many people.
                    </p>

                    <p className='text-xl bg-green text-white py-2 px-2 w-32 mb-2'>Louis Smirf</p>
                    <h4 className='text-black opacity-40'>/ Design Leader – Aqua Group</h4>
                </div>

                <div data-aos="flip-up" className='bg-white bg-opacity-35 py-6 px-4'>
        ...
        <div>
         ...
         <div>
            {/* another section */}
            <div className='px-8 py-6 grid  lg:grid-cols-2 md:grid-cols-2 grid-cols-1 gap-6 mb-6 border-b-2 relative lg:top-0 md:top-28 top-0 border-green'>
            <div >
            <h1 className='lg:text-5xl md:text-5xl text-2xl mb-4 text-green px-4 font-semibold'>Requirements</h1>
            <div className='flex gap-4'>
                <FaArrowRight size={25} className='mt-3 text-green'/>
            ...
            <div>
            <h1 className='lg:text-5xl md:text-5xl text-2xl mb-4 text-green px-4 font-semibold'>Our solution</h1>
            <div className='flex gap-4'>
         ...
         <div className='px-8 py-6 grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 relative lg:top-0 md:top-28 top-0  gap-6 mb-6 border-b-2 border-green'>
            <div>
            <div className='flex gap-4'>
                <FaArrowRight size={25} className='mt-3 text-green'/>
         ...
         <div className='px-8 py-6 relative lg:top-0 md:top-28 top-0 grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 gap-6 mb-6 border-b-2 border-green'>
            <div>
            <div className='flex gap-4'>
                <FaArrowRight size={25} className='mt-3 text-green'/>
         ...
         <div className='lg:px-48 md:px-10 px-8 py-6 relative lg:top-0 md:top-20 top-0 grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 gap-6 mb-16'>
            <div>
            <div className='flex gap-4'>
         ...
         <div className='lg:px-48 md:px-10 px-8 gap-6 grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 mb-6'>
            <div className='relative mb-4'>
              ...
              <div className=' peer-checked:text-green'><h1 className='text-xl font-semibold px-8'>New Multiple Site Connectivity</h1></div>
            ...
            <div className='relative mb-4'>
              <input type='checkbox' className='w-40 h-6 z-10 absolute opacity-0 peer transition-transform'/>
              <div className=' peer-checked:text-green peer-checked:rotate-180 absolute'><FaChevronCircleDown size={25}/></div>
              <div className=' peer-checked:text-green'><h1 className='text-xl font-semibold px-8'>IT Security & Software</h1></div>
              <div className='px-2 py-2 duration-500 hidden peer-checked:block'>
                <p>
            ...
            <div className='relative mb-4'>
              <input type='checkbox' className='w-40 h-6 z-10 absolute opacity-0 peer transition-transform'/>
              <div className=' peer-checked:text-green peer-checked:rotate-180 absolute'><FaChevronCircleDown size={25}/></div>
              <div className=' peer-checked:text-green'><h1 className='text-xl font-semibold px-8'>Weak Hosted Capability</h1></div>
              <div className='px-2 py-2 duration-500 hidden peer-checked:block'>
                <p>
            ...
            <div className='relative mb-4'>
              <input type='checkbox' className='w-40 h-6 z-10 absolute opacity-0 peer transition-transform'/>
              <div className=' peer-checked:text-green peer-checked:rotate-180 absolute'><FaChevronCircleDown size={25}/></div>
              <div className=' peer-checked:text-green'><h1 className='text-xl font-semibold px-8'>Build Internet Network</h1></div>
              <div className='px-2 py-2 duration-500 hidden peer-checked:block'>
                <p>
