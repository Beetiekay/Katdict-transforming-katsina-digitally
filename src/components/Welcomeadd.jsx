...
const Welcomeadd = () => {
  return (
    <div className='w-[100%] min-h-[100vh]'>
      <div className='grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 gap-4'>
        ...
        <div className='px-6 opacity-75 flex items-center'>
          ...
          <div>
            ...
            <p className=' lg:text-2xl md:text-xl font-semibold mb-6'><span className='text-green'>- Naufal Ahmad</span> Director General</p>
      ...
      <p className='font-semibold py-4 pt-16 text-lg lg:text-center md:text-center text-start opacity-85'>OUR FOCUS <span className='text-green'>AREAS</span></p>
         <div className='flex justify-center mb-4'><h1 className=' lg:text-4xl md:text-4xl text-2xl font-semibold lg:text-center md:text-center text-start mb-4'>WE ARE CRAFTING<span className='text-green'> KATSINA'S DIGITAL</span> LEGACY.</h1></div>

         {/* cards */}
         <div className='w-[100%] grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-5 lg:px md:px-5-10 mb-10'>
            {/* 1 */}
            <div className='bg-green bg-opacity-60 rounded-lg shadow-md cursor-pointer'>
         ...
         <div className='grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 gap-6 lg:px-96 md:px-20'>
           ...
           <button className='w-full py-4 border-2 rounded-lg border-green hover:translate-y-1 duration-700 ease-out transition-all hover:bg-green hover:text-white'>
            Request Our Service
           </button>
         </div>
    </div>
