...
const Eyeonkt = () => {
  return (
     <div className='w-full min-h-full relative dark:bg-black overflow-hidden'>
        <img src={imagelayer} className='w-full h-[100vh] dark:opacity-15 absolute top-0 hue-rotate-180  object-cover opacity-75'/>
        ...
        <div className='absolute z-20'><Navigation/></div>
          <div className='py-40 lg:h-[99.8vh] md:h-[99.8vh] h-[97vh] bg-black bg-opacity-35'>
            ...
            <h1 className='lg:text-7xl md:text-7xl lg:mt-0 md:mt-0 mt-10 text-white text-2xl text-center font-semibold mb-14'>How innovation drives
