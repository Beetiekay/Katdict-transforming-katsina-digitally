...
const Details = () => {
  ...
  return (
    <div className='py-5 relative'>
        ...
        <p data-aos="fade-right" className='lg:text-lg md:text-lg text-sm font-semibold px-5 mb-6'>
          ...
          * Data analysis and digital monitoring tools can be used to track environmental indicators and support sustainable resource management.
          ...
          <div className='px-6 mb-4'><div className='h-1 w-28 bg-green rounded-2xl'></div></div>
           ...
           <div>
            ...
            <p data-aos="fade-up" className='bg-black lg:text-base md:text-base text-sm bg-opacity-5 py-6 lg:px-4 md:px-4 px-2 text-center rounded-2xl shadow-md lg:w-[50%] md:w-[70%] w-full'>By continuing to play a leading role in these areas, KATDICT can significantly contribute to the digital transformation of Katsina State and improve the lives of its citizens.</p>
            </div>
           </div>
        </div>
    </div>
