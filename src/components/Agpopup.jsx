            ...
            <div>
              ...
              <img src={katdict} className='w-14 dark:bg-black bg-green px-1'/>
               ...
               <p className='text-xs px-2 font-mono font-semibold dark:text-white text-green'>KATSINA DIRECTORATE OF INFORMATION & COMMUNICATIONS TECHNOLOGY</p>
                ...
                <h1 className='lg:text-6xl md:text-4xl text-4xl  mb-6  text-green text-center font-bold mt-2'>Welcome To <br className='lg:hidden md:hidden flex'/> Katdict !</h1>
                ...
                <div className='lg:px-6 md:px-6 px-2 lg:mt-0 md:mt-0 -mt-2'><p className='lg:text-xl dark:opacity-85 dark:text-white md:text-xl text-sm text-center font-semibold px-8'>Beyond The Surface, A World Of Possibilities.</p></div>

                 <div className='flex justify-center items-center mt-3'>
                  <button onClick={() => setOpen(false)} className='lg:py-3 md:py-3 py-3 flex items-center dark:bg-opacity-45 gap-2 lg:px-8 md:px-8 px-6 rounded-xl font-semibold lg:text-xl md:text-xl text-sm bg-green text-white'>
                  <p>Proceed</p>
