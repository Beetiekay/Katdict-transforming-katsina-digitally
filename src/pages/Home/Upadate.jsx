...
const Upadate = () => {
  ...
  return (
    <div className='w-[100%] min-h-[100vh]'>
       ...
       <div className='flex justify-center mb-16'><h1  className=' dark:text-white lg:text-4xl md:text-4xl text-2xl font-semibold lg:text-center md:text-center text-start mb-4'>STAY INFORMED, <span className='text-green'> AS WE SHAPE TOMORROW</span> LEGACY.</h1></div>
       ...
       <div className='grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 gap-5 lg:px-36 md:px-8 px-1 mb-10'>
        ...
        <div dat-aos="zoom-in" className='lg:px-24 md:px-0 p-1 relative  z-0'>
            ...
            <img src={pattern} className='absolute object-cover opacity-5'/>
              ...
              <div className='mb-2'>
              <h1 className='px-4 flex items-center gap-4 lg:text-lg md:text-lg text-xs'>Apply Now <a href='https://levelupkatsina.katdict.ng/' target='_blank' className='bg-cobalt px-2 text-white py-1'>Katdictng/levelup-katsina</a>
              </h1>
              </div>
            </div>
        </div>
       ...
       <div className='flex justify-center lg:px-36 mb-6 text-white '><Link to={"recent"} className='hover:scale-110 duration-500 py-2 px-6 rounded-xl bg-green'>View More</Link></div>
