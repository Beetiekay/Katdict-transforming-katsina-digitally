  ...
  return (
      <div className='w-[100%] overflow-hidden'>
        ...
        <div className=' lg:bg-opacity-0 md:bg-opacity-0 bg-opacity-100 bg-green py-5 rounded-2xl mt-44'>
          <div>
          <h1 data-aos="fade-right" className='lg:text-4xl dark:text-white lg:text-black lg:text-center md:text-start  md:text-black text-white md:text-2xl text-xl lg:px-14 md:px-10 px-4 text-start'>About <span className='font-bold lg:opacity-100 md:opacity-100 opacity-60 lg:text-green md:text-green text-black'>KATDICT</span>
          </h1>
