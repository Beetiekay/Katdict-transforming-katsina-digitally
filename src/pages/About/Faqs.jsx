  ...
  return (
    ...
    <div className='min-h-[100vh] w-[100%] flex justify-center items-center relative'>
      <div className='mt-56 flex justify-around flex-wrap items-center gap-5'>
        <div>
          <h1 data-aos="fade-right" className='lg:text-2xl md:text-2xl text-xl mt-5 lg:px-4 md:px-4 px-4 lg:text-center md:text-center text-start mb-4'><span className='font-bold text-green'>QUESTIONS?</span> We'are Glad You Asked</h1> 
