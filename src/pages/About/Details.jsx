...
const Details = () => {
  ...
  return (
    <div className='py-5'>
        ...
        <p data-aos="fade-right" className='text-lg font-semibold px-5 mb-6'>
         ...
         <p className='text-lg font-semibold px-5'>
          ...
          <div className='px-4'>
          <p className=' bg-green text-white py-4 px-4 rounded-b-2xl'>
          ...
          * Data analysis and digital monitoring tools can be used to track environmental indicators and support sustainable resource management.
          ...
          <p data-aos="fade-right" className='text-lg font-semibold px-6'>Recommendations for KATDICT:</p>
          <div className='px-6 mb-4'><div className='h-1 w-28 bg-green rounded-2xl'></div></div>
           
           <p data-aos="fade-up" className='px-6 lg:w-[50%] md:w-[80%] w-[100%] mb-4'>
           ...
           <div>
            ...
            <p data-aos="fade-up" className='bg-black bg-opacity-5 py-6 px-4 text-center rounded-2xl shadow-md lg:w-[50%] md:w-[70%] w-full'>By continuing to play a leading role in these areas, KATDICT can significantly contribute to the digital transformation of Katsina State and improve the lives of its citizens.</p>
            </div>
           </div>
        </div>
    </div>
