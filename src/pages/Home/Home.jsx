...
import bg from "../../assets/katdick1.jpg"
import Tab from './Tab'
...
const Home = () => {
  ...
  return (
    <div className='w-full lg:min-h-[100vh] md:min-h-[100vh] min-h-[80vh] bg-green bg-opacity-30 overflow-x-hidden'>
     <img src={bg} className='w-full h-[100vh] absolute top-0 object-cover opacity-15'/>
      <div>
         <div className='absolute z-20'><Navigation/></div>
         <div className='min-h-[100vh] w-[100%] flex justify-center items-center relative'>
          <div>
           <h1 data-aos="fade-right" className='lg:text-6xl md:text-6xl text-4xl text-center font-semibold mb-4'>Crafting Tomorrow's <span className='text-green'>Technologies</span> Today!</h1> 
